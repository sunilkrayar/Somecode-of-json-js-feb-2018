...
// declaring listpokemon as variable//


    var listPokemon = {
  "pokemon": [{                  //pokemon is a array of object list which store the all the information // 
    "id": 1,
    "num": "001",
    "name": "Bul",
...
var myFunction = function(name,listPokemon){ // decalring function//

for(check in listPokemon.pokemon){       //itarating the array of object//
    
  if(listPokemon.pokemon[check].name==name){ //checking the condition that match object name//
    var details =listPokemon.pokemon[check];  /
    console.log(details) //displaying result//
    break;
  }
  
}
}
var name =window.prompt(' enter  valid input '); //declaring variable
myFunction(name,listPokemon);//calling function//
...
var myFunction = function(name,listPokemon){ //decalring function//
  ...
  for(x in listPokemon.pokemon){ //itarating the loop in array of object//
    for(y in listPokemon.pokemon[x].next_evolution){ //again itarating inside object field//
      if (listPokemon.pokemon[x].next_evolution[y]=name) { //condition for check the object name is matched or not//
        var details = listPokemon.pokemon[x];
        console.log(details.name)//displaying result//
        break;
      }
 ...
 var name =alert('List of all pokemon that have  next_evolution field.');//declaring variable name//
 myFunction(name,listPokemon)//calling function//
...
var myFunction =function(weaknesses,listPokemon){ //declaring function//

  for(x in listPokemon.pokemon){ //itarating loop inside the array of object//
    for(y in listPokemon.pokemon[x].weaknesses){ //itarating loop inside the object weaknesses//
    if(listPokemon.pokemon[x].weaknesses[y]==weaknesses){  //checking the condition if its match the object name//
      var details =listPokemon.pokemon[x];
      console.log(details.name); //displaying result//
      break;//exit the loop if condition is true//
          ...
          var weaknesses =window.prompt('enter the field of weaknesses')//declaring variable//
          myFunction(weaknesses,listPokemon); //calling function //
